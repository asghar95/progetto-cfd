...
Point(66) = {1.07889, -0.134152, 0.0, h_flap};
Point(67) = {1.07524, -0.130599, 0.0, h_flap};
...
Point(101) = {1.06988, -0.138924, 0.0, h_bu_flap};
Point(102) = {1.0736, -0.142386, 0.0, h_bu_flap};
